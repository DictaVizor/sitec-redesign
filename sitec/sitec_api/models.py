...
class SitecApi:
    ...
    def retrieve_cycle_advance_data(self):
        ...
        for grouped_table in grouped_tables:
            ...
            subject_data['title'] = grouped_table[0].find('tbody').find_all('tr')[0].find_all('td')[1].string

            day_count = 1
            for day_td in grouped_table[1].find('tbody').find_all('tr')[1].find_all('td'):
                ...
                if len(day_data) == 2:
                    ...
                    day_count += 1
            units = grouped_table[2].find('tbody').find_all('tr')[1].find_all('td')[1:]#Skip the first element since its s**t
